<div class="col-sm-12 col-xl-12">
    <div class="bg-light rounded h-100 p-4">
        ...
        <form>
            ...
            <div class="row mb-3">
                <label for="inputTanggal3" class="col-sm-2 col-form-label">Foto E-Ktp</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="inputTanggal3" class="col-sm-2 col-form-label">Screenshot Instagram</label>
                <div class="col-sm-10">
                    <form wire:submit.prevent="save">
                        <input type="file" wire:model="photo">
            ...
            <div class="row mb-3">
                <label for="inputTanggal3" class="col-sm-2 col-form-label">Screenshot Facebook</label>
                <div class="col-sm-10">
                    <form wire:submit.prevent="save">
                        <input type="file" wire:model="photo">
